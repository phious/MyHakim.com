...
<div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-timer menu-active menu-icon-timer-active">
                        <a href="Pending_appointments.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Pending Appointments</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
