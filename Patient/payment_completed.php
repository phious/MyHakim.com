...
<option value="">--Please choose an option--</option>
  ...
  <option value="Amole">Chappa</option>
        ...
        <input type="submit" value="proceed to Paymet" class="btn-primary-soft btn button-icon"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;">
    </form>
